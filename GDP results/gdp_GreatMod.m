% gdp_GreatMod.m
% Epoch Analysis: The Great Moderation (1984 - 2007)

clear; clc;
load('Gdp_Data.mat');

disp('Configuring Data for Great Moderation (1984 - 2007)...');

% Finds the dates for the epoch
epoch_idx = year(dateVec) >= 1984 & year(dateVec) <= 2007;
...
% 4Adjusts the MCMC starting markers
...
disp('Saving Results...');
save('gdpResults_GreatMod.mat', 'gamDraws', 'muDraws', 'rho1Draws', 'rho2Draws', 'sigDraws');
disp('Great Moderation Analysis Complete!');